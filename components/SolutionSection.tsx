        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 relative group">
            ...
            <div className="relative bg-slate-900 rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white">
              <img
                src="https://cdn.shopify.com/s/files/1/0668/4275/5223/files/A_medium_shot_2k_202601040451.webp?v=1767513144"
                alt="A medium shot 2k - Não tente reinventar a roda. Copie o que já funciona"
